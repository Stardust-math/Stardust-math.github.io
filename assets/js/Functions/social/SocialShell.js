(function () {
  ...
  function dispatchSocialViewChange(view) {
    try {
      ...
      // A view change event is optional.
    }
  }
  ...
  function renderSections() {
    ...
    if (
      ...
      parts.push(
        window.SocialAnimeRender.render({
          active: false
        })
      );
    }
  ...
  function runViewEnter(view) {
    ...
    if (view === 'anime') {
      if (
        window.SocialAnime &&
        typeof window.SocialAnime
          .enter === 'function'
      ) {
        window.SocialAnime.enter();
      }
    }
  }
